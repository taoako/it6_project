...
<head>
    ...
    <style>
        ...
        .login-form {
            width: 100%;
            max-width: 300px;
            /* Limit form width for better aesthetics */
        }
        ...
        .action-btn {
            ...
            /* Gray-purple color from the image */
            border: none;
            border-radius: 50px;
            padding: 15px 0;
            /* Increased padding */
        ...
        .divider {
            width: 2px;
            /* Made divider thicker */
            background-color: #dee2e6;
            margin: 0 30px;
            /* Increased margin */
            align-self: stretch;
            /* Make divider full height */
        }
